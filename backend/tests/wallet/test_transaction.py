...
def test_transaction_update():
    sender_wallet=Wallet()
    firsr_recipient='first_recipient'
    first_amount=50
    transaction=Transaction(sender_wallet,firsr_recipient,first_amount)
    ...
    transaction.update(sender_wallet,firsr_recipient,to_first_again_amount)
    assert transaction.output[firsr_recipient]==first_amount+to_first_again_amount
